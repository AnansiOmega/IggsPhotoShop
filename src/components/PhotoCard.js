    ...
    return(
        <div className='image-card'>
            ...
            <div className='innards'>
                ...
                <button aria-label='download button' className='ui button circular'><a style={{color: 'black'}} href={link} target="_blank" rel="noreferrer noopener"><i className="download icon"></i></a></button>
                ...
                <button aria-label='add to cart button' className='ui button circular' onClick={() => dispatch(addToCart(photo))}><i style={{color: 'black'}} className="cart plus icon"></i></button>
            </div>
        </div>
    )
}